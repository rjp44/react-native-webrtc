...
- (void)emitMuteEvent:(BOOL)muted {
    [self.module.bridge.eventDispatcher
        sendDeviceEventWithName:@"peerConnectionSignalingStateChanged"
...
- (void)addVideoTrackAdapter:(NSString*)streamReadtId track:(RTCVideoTrack*)track {
